            ...
            <section className="about-section  py-12 px-4 sm:px-6 lg:px-8" >
                <div className="about-content flex flex-col lg:flex-row items-center justify-center text-center lg:text-left">
                    ...
                    <div className="lg:w-1/2 flex flex-col items-center lg:items-start">
                        <h3 className="text-4xl text-gray-900 mb-4">ABOUT POPOUTBOX</h3>
                        <p className="text-lg text-gray-700 mb-6 text-justify">POPOUTBOX PRIVATE LIMITED Automated Storage Keyless Lockers is a self-service that allows you to book lockers 24/7. Our facility provides storage for your bags, backpacks, and other personal items.</p>
