...
import { LiveBot } from "../redirect/LiveBot";
import './BookingPage.css'
import { detectOS } from "../../utils/detectos";
import QrGenerator from "../qr/QrGenerator";


export const PopkeyBook = () => {
  ...
  const getApiAfterDelay = () => {
    // Set a delay of 10 seconds (10,000 ms)
    setTimeout(async () => {
      try {
        alert('10 seconds have passed');

        const response = await axios.get(`${currentDomain}/api/check_payment_status/qr_PEr8hAo8tXe13v`);
      } catch (error) {
          ...
          <div className="container max-w-md bg-white shadow-lg rounded-3xl p-6 space-y-3 border border-gray-200">
            ...
            <div className="flex items-center space-x-2">
              ...
              >
                I agree to the{" "}
                <a
                  href="https://popkey.in/terms-conditions"
                ...
                ,{" "}
                <a
                  href="https://popkey.in/privacy-policy"
                  className="text-indigo-600 hover:underline"
                >
                  Privacy Policy
                </a>
                ,{" "}
                <a
                  href="https://popkey.in/prohibited-items-policy"
                  className="text-indigo-600 hover:underline"
                >
                ...
                , and{" "}
                <a
                  href="https://popkey.in/refund-policy"
                  className="text-indigo-600 hover:underline"
                >
                  Refund Policy
                </a>
